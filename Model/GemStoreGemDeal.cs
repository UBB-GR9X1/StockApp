...
{
    public class GemStoreGemDeal : INotifyPropertyChanged
    {
        ...
        public GemStoreGemDeal(string title, int gemAmount, double price, bool isSpecial = false, int? durationMinutes = null)
        {
            Title = title;
            GemAmount = gemAmount;
            Price = price;
