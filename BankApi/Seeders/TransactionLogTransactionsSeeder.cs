        ...
        protected override async Task<string> GetQueryAsync()
        {
            ...
            return $@"
                ...
                BEGIN
                    ...
                    VALUES
                        ({userIds[0]}, 'AAPL', 'Apple Inc.', 'BUY', 10, 150, '2025-04-01'),
                        ({userIds[1]}, 'GOOGL', 'Alphabet Inc.', 'SELL', 5, 2800, '2025-03-15'),
                        ({userIds[2]}, 'TSLA', 'Tesla Inc.', 'BUY', 20, 750, '2025-02-20'),
                        ({userIds[3]}, 'AMZN', 'Amazon.com Inc.', 'SELL', 8, 3400, '2025-01-10'),
                        ({userIds[4]}, 'MSFT', 'Microsoft Corp.', 'BUY', 15, 320, '2025-05-05');
                END;
            ";
        }
    }
