...
namespace StockApp.ViewModels.Tests
{
    ...
    public class ArticleCreationViewModelTests
    {
        ...
        private Mock<IBaseStocksApiService> _stocksServiceMock;
        ...
        public void Setup()
        {
            ...
            _stocksServiceMock = new Mock<IBaseStocksApiService>();
            _stocksServiceMock.Setup(r => r.GetAllStocksAsync()).ReturnsAsync(new List<BaseStock>());
